...
void SparkBase::SendControlMessage(APICommand cmd, std::string commandName, float value, std::optional<float> minValue,
                                   std::optional<float> maxValue) const
{
    ...
    {
        throw std::out_of_range(RED + commandName + " must be between " + std::to_string(*minValue) + " and " +
...
void SparkBase::SetParameter(Parameter parameterId, uint8_t parameterType, std::string parameterName,
                             ...
                             std::optional<std::string> customErrorMessage)
{
    ...
    auto throwRangeError = [&](auto min, auto max) {
        ...
        {
            throw std::out_of_range(RED + parameterName + " must be between " + std::to_string(min) + " and " +
...
{
    static const std::array<Parameter, 4> params = {Parameter::kIZone_0, Parameter::kIZone_1, Parameter::kIZone_2,
                                                    Parameter::kIZone_3};
...
{
    static const std::array<Parameter, 4> params = {Parameter::kDFilter_0, Parameter::kDFilter_1, Parameter::kDFilter_2,
...
{
    static const std::array<Parameter, 4> params = {
        Parameter::kSmartMotionMaxAccel_0, Parameter::kSmartMotionMaxAccel_1, Parameter::kSmartMotionMaxAccel_2,
...
{
    static const std::array<Parameter, 4> params = {Parameter::kSlot3Placeholder1_0, Parameter::kSlot3Placeholder1_1,
...
{
    static const std::array<Parameter, 4> params = {Parameter::kSlot3Placeholder2_0, Parameter::kSlot3Placeholder2_1,
...
{
    static const std::array<Parameter, 4> params = {Parameter::kSlot3Placeholder3_0, Parameter::kSlot3Placeholder3_1,
...
{
    SetParameter(Parameter::kAltEncoderCountsPerRev, PARAM_TYPE_UINT, "Alternate Encoder Counts Per Revolution",
                 counts);
}
...
{
    return GetPIDParam<float>(Parameter::kSmartMotionAllowedClosedLoopError_0, slot,
